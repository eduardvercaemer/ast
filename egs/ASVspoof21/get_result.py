...
# summarize ASVspoof 5-fold cross validation result
...
if __name__ == '__main__':
    ...
    # note this is "chose the best epoch based on AVERAGED accuracy across 5 folds", not the best epoch for each fold
